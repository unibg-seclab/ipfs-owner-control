...
#define MINI_SIZE 4
// Obtained in order to have a MACRO_SIZE of exactly 256 KB = MINI_SIZE *
// (MINI_PER_BLOCK ^ 8)
#define MINI_PER_MACRO 65536
...
typedef void (*mixfn)(const unsigned char *macro, unsigned char *out,
                      unsigned char *buffer, const unsigned char *key,
                      const unsigned char *iv);

void mixprocess(mixfn fn, const unsigned char *data, unsigned char *out,
                const unsigned long size, const unsigned char *key,
                const unsigned char *iv);
